...
library(UsingR)
data(father.son)
y <- (father.son$sheight - mean(father.son$sheight)) / sd(father.son$sheight) # mean = 0 variance = 1
x <- (father.son$fheight - mean(father.son$fheight)) / sd(father.son$fheight) # mean = 0 variance = 1
rho <- cor(x, y)
